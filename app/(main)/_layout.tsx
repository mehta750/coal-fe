...
export default function DrawerLayout() {
  ...
  return (
    <Drawer screenOptions={{
      ...
      headerRight: () => (
        <View style={{ flexDirection: 'row', gap: moderateScale(12), marginRight: scale(10), alignItems: 'center' }}>
          <Dropdown mode='modal' w={54} round h={22} renderRightIcon={false} data={languages} setValue={setLang} value={lang} />
      ...
      headerLeft: () => (
        <Pressable
          ...
          style={{
            ...
            flexDirection: 'row', alignItems: 'center', gap: 5, marginLeft: scale(10)
          }}
        >
          <Image
